...
- **Backup**: [NAME] (@[GITHUB-USERNAME]) — covers when owner is OOO
...
| Merging (owner only) | "Merge this PR." (Otherwise: "Tag [owner] for review.") |
...
Ask your Claude to explain before doing anything. Or ping the owner.
